      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <h2 className="font-bold text-gray-800 sm:truncate sm:text-2xl sm:tracking-tight mb-3">
                Sei sicuro di voler eliminare il tour?
              </h2>
              <button
                type="button"
            ...
            userTours.map(userTour => {
              return (
                <div key={userTour._id} className="relative">
                  ...
                  />
                  <p
                    className="absolute bg-red-800 text-white w-8 h-8 rounded-full flex items-center justify-center top-2 right-2 hover:scale-105 cursor-pointer"
                    onClick={() => {
                      setConfirmationModalOpen(true);
                      setTourId(userTour._id);
                    }}
                  >
                    <TbTrash />
                  </p>
