                                ...
                                return (
                                    <div key={userTour._id} className="relative">
                                        <SmallCard
                                            ...
                                            id={userTour._id}
                                        />
                                        <p className="absolute bg-red-800 text-white w-8 h-8 rounded-full flex items-center justify-center top-2 right-2 hover:scale-105 cursor-pointer" onClick={() => { setConfirmationModalOpen(true); setTourId(userTour._id) }}><TbTrash /></p>

                                    </div>
                                )
                            })
                            : <h3 className="text-2xl font-semibold text-gray-800">Nessun Tour inserito</h3>
                    }
                </div>
            </SectionContainer>
        </>
