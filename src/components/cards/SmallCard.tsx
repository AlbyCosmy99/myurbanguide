                ...
                <div className="border border-gray-300 rounded-lg">
                    ...
                    <div role="status" className="p-4 rounded-lg animate-pulse md:p-6 dark:border-gray-700">
                        ...
                        <div className="flex items-center mt-4">
                            <svg className="w-10 h-10 me-3 text-gray-100 dark:text-gray-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                <Link to={"/tours/" + id}>
                    <div className="border border-gray-300 rounded-lg cursor-pointer hover:scale-105 transition duration-200 ease-out">
                        ...
                        <div role="status" className="p-4 md:p-6 dark:border-gray-700">
                            ...
                            <div className="flex items-center mt-4">
                                <img className="w-10 h-10 rounded-full me-3" src="src/assets/img/logo-ico.png" alt="ico-user" />
                                <div>
                                    <p className="text-sm"><span className="font-bold">Prezzo:</span> {price}€</p>
                                    <p className="text-sm"><span className="font-bold">Durata:</span> {duration}</p>
                                </div>
                            </div>
